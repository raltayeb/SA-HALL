  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: "h-7 w-7 bg-white border border-gray-100 rounded-lg flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary transition-all",
        ...
        day_today: "bg-primary/5 text-primary border border-primary/20",
