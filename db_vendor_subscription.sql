-- ============================================
-- Vendor Subscription & Lifetime Plans
-- ============================================

-- 1. Add subscription tracking to vendors/profiles
...
-- 2. Create subscriptions table for tracking
...
-- 4. Create index for auto-expiry check
...
-- 5. Create invoices table (Zakat & Tax compliant)
...
-- 6. Create expenses table (Zakat & Tax compliant)
...
RETURNS void AS $$
BEGIN
    -- Deactivate expired featured halls
    UPDATE halls
    SET is_featured = FALSE, featured_until = NULL
    WHERE featured_until IS NOT NULL 
    AND featured_until < NOW();
    
    -- Also update featured_halls table
...
-- 10. Create trigger to check expiry on hall access
...
-- 11. Insert default system settings for zakat/vat
